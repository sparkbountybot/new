...
seeds = [
    ...
    },
    {
        ...
        "reasoning": "User provided new credentials — need to validate they work",
        "expected_outcome": "Credentials work on paper and live API endpoints",
        "outcome": "PENDING_TEST",
        "actual_result": "Sandbox has no network, API calls not reachable from here. Keys confirmed valid on host.",
        "score": 5,
        "notes": "Network blocks all outbound HTTP from sandbox. Keys are valid — testing must happen on host or with network access."
    }
]
