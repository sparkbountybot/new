...
Tracks decisions, measures outcomes, evolves strategies.

Both sandboxes contribute to shared files in the repo.
Periodic evolution cycles analyze experiences and update strategy parameters.
